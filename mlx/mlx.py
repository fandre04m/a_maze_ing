...
from ctypes import CDLL, c_void_p, c_int, c_uint, c_char_p, c_char, POINTER, \
    byref, addressof, CFUNCTYPE, py_object
import os
...
class Mlx:
    def __init__(self) -> None:
        ...
        self._python_ref_std: dict[Any, Any] = {}
        self._python_ref_gen: dict[Any, Any] = {}
        self._img_height: dict[Any, Any] = {}
...
# Windows
    def mlx_new_window(
            self, mlx_ptr: Any, width: Any, height: Any, title: Any
    ) -> Any:
...
# API break, returns tuple
    def mlx_get_data_addr(self, img_ptr: Any) -> Any:
        ...
        return (
            memoryview(data_view).cast('B'), bits_per_pixel.value,
...
#  Use C^-\ to kill your program.
    ...
    def mlx_mouse_hook(self, win_ptr: Any, callback: Any, param: Any) -> Any:
    ...
    def mlx_expose_hook(self, win_ptr: Any, callback: Any, param: Any) -> Any:
    ...
    def mlx_loop_hook(self, mlx_ptr: Any, callback: Any, param: Any) -> Any:
    ...
    def mlx_hook(
            self, win_ptr: Any, x_event: Any, x_mask: Any, callback: Any,
            param: Any
    ) -> Any:
        x_event_key = [2, 3]
        x_event_mouse = [4, 5]
...
# API break, returns tuple
    def mlx_xpm_file_to_image(self, mlx_ptr: Any, filename: Any) -> Any:
        width = c_uint()
        height = c_uint()
...
# API break, returns tuple
    def mlx_png_file_to_image(self, mlx_ptr: Any, filename: Any) -> Any:
        width = c_uint()
        height = c_uint()
...
# API break, returns tuple
    def mlx_mouse_get_pos(self, mlx_ptr: Any) -> Any:
        x = c_int()
        y = c_int()
...
# API break, returns tuple
    def mlx_get_screen_size(self, mlx_ptr: Any) -> Any:
        w = c_uint()
        h = c_uint()
